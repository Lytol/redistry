    ...
    describe CollectionProxy do
      ...
      describe 'instantiation' do
        ...
        context 'required parameters' do
          ...
          it 'should use nil for size' do
            proxy.options[:size].should == nil
          end
        end
        ...
        context 'serializer' do
          describe 'given that the loaded frameworks include :activerecord' do
            before do
              set_loaded_frameworks(:activerecord)
            end
            ...
            context 'and the passed in class inherits from ActiveRecord::Base' do
              ...
              context "and the json serisalizer is specified" do
                before do
                  @proxy = CollectionProxy.new(@doctor_dre, collection_name, :serializer => :json)
                end
